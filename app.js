...
startButton.addEventListener("click", function(){
    ...
    range.classList.add("afterrange");
    label.classList.add("afterrange");
    ...
    hint.innerText=`Enter your guess between 1 and ${range.value} inclusive`;
    let attempt = document.querySelector(".attempts");
        ...
        submit.addEventListener("click",function(event){
            ...
            attempt.innerText = `Attempts: ${count++}`;
